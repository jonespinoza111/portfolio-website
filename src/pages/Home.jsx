      ...
      <section className="h-auto front-section flex flex-col md:flex-row justify-center items-center text-black mr-5">
        <div className="quick-description md:pl-20 pl-0 md:mt-0 mt-10">
          ...
          <p className="md:w-[500px] w-[300px] mb-5 md:text-[18px] text-[16px]">
            Welcome to my portfolio website! I am a highly skilled developer based in Florida, with a passion for creating visually stunning and intuitive websites that provide a seamless user experience.
            Browse my portfolio to see examples of my work, and contact me to discuss opportunities. 
          </p>
