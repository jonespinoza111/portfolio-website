      ...
      <SlideMotion direction={'up'}>
        {['github', 'linkedin', 'gmail'].map((num, index) => (
          <>
            ...
            {num === "linkedin" && (
              <a  key={index} href="https://www.linkedin.com/in/jonathan-espinoza-21965a184" className={`social-button btn ${num} flex items-center justify-center h-[70px] w-[70px]`} target="_blank">
